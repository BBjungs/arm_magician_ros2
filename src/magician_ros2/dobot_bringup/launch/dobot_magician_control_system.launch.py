...
def generate_launch_description():
    ...
    tool_mapping = str(os.environ.get('DOBOT_TOOL_MAPPING', 'canonical')).strip().lower()
    ...
    suction_tool = ["'", tool_env_var, "' == 'suction_cup'"]
    # -----------------------------------------------------------------------------------------------------------------
    ...
    gripper = Node(
        ...
        output='screen',
        condition = IfCondition(PythonExpression(gripper_tool))
    )
    ...
    suction_cup = Node(
        ...
        output='screen',
        condition = IfCondition(PythonExpression(suction_tool))
    )
