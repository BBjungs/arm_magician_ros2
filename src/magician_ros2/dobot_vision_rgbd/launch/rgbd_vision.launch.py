...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('camera_freshness_timeout_s', default_value='1.5'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'freshness_timeout_s': ParameterValue(
                    LaunchConfiguration('camera_freshness_timeout_s'), value_type=float,
                ),
                'enable_cloud_health_validation': ParameterValue(
                    LaunchConfiguration('enable_cloud_health_validation'), value_type=bool,
                ),
            }],
        ),
        DeclareLaunchArgument('debug_enabled', default_value='false'),
        DeclareLaunchArgument('start_object_fusion', default_value='false',
                              choices=['true', 'false']),
        Node(
            ...
            }], condition=IfCondition(LaunchConfiguration('start_object_fusion')),
        ),
    ])
