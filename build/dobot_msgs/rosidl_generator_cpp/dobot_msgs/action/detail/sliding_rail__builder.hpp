...
class Init_SlidingRail_SendGoal_Event_response
{
public:
  explicit Init_SlidingRail_SendGoal_Event_response(::dobot_msgs::action::SlidingRail_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::dobot_msgs::action::SlidingRail_SendGoal_Event response(::dobot_msgs::action::SlidingRail_SendGoal_Event::_response_type arg)
  {
...
private:
  ::dobot_msgs::action::SlidingRail_SendGoal_Event msg_;
};

class Init_SlidingRail_SendGoal_Event_request
{
public:
  explicit Init_SlidingRail_SendGoal_Event_request(::dobot_msgs::action::SlidingRail_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_SlidingRail_SendGoal_Event_response request(::dobot_msgs::action::SlidingRail_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SlidingRail_SendGoal_Event_response(msg_);
  }
...
class Init_SlidingRail_SendGoal_Event_info
{
public:
  Init_SlidingRail_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SlidingRail_SendGoal_Event_request info(::dobot_msgs::action::SlidingRail_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SlidingRail_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::dobot_msgs::action::SlidingRail_SendGoal_Event>()
{
  return dobot_msgs::action::builder::Init_SlidingRail_SendGoal_Event_info();
}
...
class Init_SlidingRail_GetResult_Event_response
{
public:
  explicit Init_SlidingRail_GetResult_Event_response(::dobot_msgs::action::SlidingRail_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::dobot_msgs::action::SlidingRail_GetResult_Event response(::dobot_msgs::action::SlidingRail_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::dobot_msgs::action::SlidingRail_GetResult_Event msg_;
};

class Init_SlidingRail_GetResult_Event_request
{
public:
  explicit Init_SlidingRail_GetResult_Event_request(::dobot_msgs::action::SlidingRail_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_SlidingRail_GetResult_Event_response request(::dobot_msgs::action::SlidingRail_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SlidingRail_GetResult_Event_response(msg_);
  }
...
class Init_SlidingRail_GetResult_Event_info
{
public:
  Init_SlidingRail_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SlidingRail_GetResult_Event_request info(::dobot_msgs::action::SlidingRail_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SlidingRail_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::dobot_msgs::action::SlidingRail_GetResult_Event>()
{
  return dobot_msgs::action::builder::Init_SlidingRail_GetResult_Event_info();
}
