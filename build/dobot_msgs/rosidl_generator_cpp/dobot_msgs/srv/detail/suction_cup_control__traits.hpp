...
inline void to_flow_style_yaml(
  const SuctionCupControl_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SuctionCupControl_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use dobot_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dobot_msgs::srv::SuctionCupControl_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  dobot_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use dobot_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const dobot_msgs::srv::SuctionCupControl_Event & msg)
{
  return dobot_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dobot_msgs::srv::SuctionCupControl_Event>()
{
  return "dobot_msgs::srv::SuctionCupControl_Event";
}

template<>
inline const char * name<dobot_msgs::srv::SuctionCupControl_Event>()
{
  return "dobot_msgs/srv/SuctionCupControl_Event";
}

template<>
struct has_fixed_size<dobot_msgs::srv::SuctionCupControl_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dobot_msgs::srv::SuctionCupControl_Event>
  : std::integral_constant<bool, has_bounded_size<dobot_msgs::srv::SuctionCupControl_Request>::value && has_bounded_size<dobot_msgs::srv::SuctionCupControl_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<dobot_msgs::srv::SuctionCupControl_Event>
  : std::true_type {};
