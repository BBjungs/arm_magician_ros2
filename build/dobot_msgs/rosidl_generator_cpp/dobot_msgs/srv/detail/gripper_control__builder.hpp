...
{
public:
  explicit Init_GripperControl_Event_response(::dobot_msgs::srv::GripperControl_Event & msg)
  : msg_(msg)
  {}
  ::dobot_msgs::srv::GripperControl_Event response(::dobot_msgs::srv::GripperControl_Event::_response_type arg)
  {
...
private:
  ::dobot_msgs::srv::GripperControl_Event msg_;
};

class Init_GripperControl_Event_request
{
public:
  explicit Init_GripperControl_Event_request(::dobot_msgs::srv::GripperControl_Event & msg)
  : msg_(msg)
  {}
  Init_GripperControl_Event_response request(::dobot_msgs::srv::GripperControl_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GripperControl_Event_request info(::dobot_msgs::srv::GripperControl_Event::_info_type arg)
  {
...
template<>
inline
auto build<::dobot_msgs::srv::GripperControl_Event>()
{
  return dobot_msgs::srv::builder::Init_GripperControl_Event_info();
}
