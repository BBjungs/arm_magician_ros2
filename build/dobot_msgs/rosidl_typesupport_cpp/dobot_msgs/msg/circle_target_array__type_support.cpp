...
static const _CircleTargetArray_type_support_symbol_names_t _CircleTargetArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs, msg, CircleTargetArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs, msg, CircleTargetArray)),
  }
};
...
{
  return &::dobot_msgs::msg::rosidl_typesupport_cpp::CircleTargetArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_msgs, msg, CircleTargetArray)() {
  return get_message_type_support_handle<dobot_msgs::msg::CircleTargetArray>();
}
