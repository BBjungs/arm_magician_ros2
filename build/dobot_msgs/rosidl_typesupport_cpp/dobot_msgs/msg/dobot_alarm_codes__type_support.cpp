...
static const _DobotAlarmCodes_type_support_symbol_names_t _DobotAlarmCodes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs, msg, DobotAlarmCodes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs, msg, DobotAlarmCodes)),
  }
};
...
{
  return &::dobot_msgs::msg::rosidl_typesupport_cpp::DobotAlarmCodes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_msgs, msg, DobotAlarmCodes)() {
  return get_message_type_support_handle<dobot_msgs::msg::DobotAlarmCodes>();
}
