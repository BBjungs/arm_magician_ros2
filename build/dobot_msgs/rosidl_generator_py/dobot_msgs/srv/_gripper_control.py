...
class GripperControl_Event(metaclass=Metaclass_GripperControl_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs/GripperControl_Request, 1>',
        'response': 'sequence<dobot_msgs/GripperControl_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs', 'srv'], 'GripperControl_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs', 'srv'], 'GripperControl_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs.srv import GripperControl_Request
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs.srv import GripperControl_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GripperControl(metaclass=Metaclass_GripperControl):
    ...
    from dobot_msgs.srv._gripper_control import GripperControl_Event as Event
