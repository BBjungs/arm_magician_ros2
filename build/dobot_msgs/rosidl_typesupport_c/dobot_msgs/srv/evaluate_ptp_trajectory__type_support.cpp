...
static const _EvaluatePTPTrajectory_Event_type_support_symbol_names_t _EvaluatePTPTrajectory_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs, srv, EvaluatePTPTrajectory_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs, srv, EvaluatePTPTrajectory_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs, srv, EvaluatePTPTrajectory_Event)() {
  return &::dobot_msgs::srv::rosidl_typesupport_c::EvaluatePTPTrajectory_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t EvaluatePTPTrajectory_service_type_support_handle = {
  ...
  &EvaluatePTPTrajectory_Request_message_type_support_handle,
  &EvaluatePTPTrajectory_Response_message_type_support_handle,
  &EvaluatePTPTrajectory_Event_message_type_support_handle,
