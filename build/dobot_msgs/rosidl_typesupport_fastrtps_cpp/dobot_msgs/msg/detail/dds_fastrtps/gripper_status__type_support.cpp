...
#include "dobot_msgs/msg/detail/gripper_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dobot_msgs::msg::GripperStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs::msg::GripperStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs::msg::GripperStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dobot_msgs
max_serialized_size_key_GripperStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dobot_msgs::msg::GripperStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_msgs::msg::GripperStatus *>(
    untyped_ros_message);
...
{
  return &dobot_msgs::msg::typesupport_fastrtps_cpp::_GripperStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs, msg, GripperStatus)() {
  return &dobot_msgs::msg::typesupport_fastrtps_cpp::_GripperStatus__handle;
}
