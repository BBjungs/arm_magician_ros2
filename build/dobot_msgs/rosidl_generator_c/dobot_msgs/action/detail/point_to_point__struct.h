...
enum
{
  dobot_msgs__action__PointToPoint_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dobot_msgs__action__PointToPoint_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/PointToPoint in the package dobot_msgs.
typedef struct dobot_msgs__action__PointToPoint_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dobot_msgs__action__PointToPoint_SendGoal_Request__Sequence request;
  dobot_msgs__action__PointToPoint_SendGoal_Response__Sequence response;
} dobot_msgs__action__PointToPoint_SendGoal_Event;

// Struct for a sequence of dobot_msgs__action__PointToPoint_SendGoal_Event.
typedef struct dobot_msgs__action__PointToPoint_SendGoal_Event__Sequence
{
...
enum
{
  dobot_msgs__action__PointToPoint_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dobot_msgs__action__PointToPoint_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/PointToPoint in the package dobot_msgs.
typedef struct dobot_msgs__action__PointToPoint_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dobot_msgs__action__PointToPoint_GetResult_Request__Sequence request;
  dobot_msgs__action__PointToPoint_GetResult_Response__Sequence response;
} dobot_msgs__action__PointToPoint_GetResult_Event;

// Struct for a sequence of dobot_msgs__action__PointToPoint_GetResult_Event.
typedef struct dobot_msgs__action__PointToPoint_GetResult_Event__Sequence
{
