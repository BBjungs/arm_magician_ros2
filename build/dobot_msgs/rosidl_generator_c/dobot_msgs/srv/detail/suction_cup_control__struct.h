...
enum
{
  dobot_msgs__srv__SuctionCupControl_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dobot_msgs__srv__SuctionCupControl_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SuctionCupControl in the package dobot_msgs.
typedef struct dobot_msgs__srv__SuctionCupControl_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dobot_msgs__srv__SuctionCupControl_Request__Sequence request;
  dobot_msgs__srv__SuctionCupControl_Response__Sequence response;
} dobot_msgs__srv__SuctionCupControl_Event;

// Struct for a sequence of dobot_msgs__srv__SuctionCupControl_Event.
typedef struct dobot_msgs__srv__SuctionCupControl_Event__Sequence
{
