...
class Init_SetStreamProfile_Event_response
{
public:
  explicit Init_SetStreamProfile_Event_response(::orbbec_camera_msgs::srv::SetStreamProfile_Event & msg)
  : msg_(msg)
  {}
  ::orbbec_camera_msgs::srv::SetStreamProfile_Event response(::orbbec_camera_msgs::srv::SetStreamProfile_Event::_response_type arg)
  {
...
private:
  ::orbbec_camera_msgs::srv::SetStreamProfile_Event msg_;
};

class Init_SetStreamProfile_Event_request
{
public:
  explicit Init_SetStreamProfile_Event_request(::orbbec_camera_msgs::srv::SetStreamProfile_Event & msg)
  : msg_(msg)
  {}
  Init_SetStreamProfile_Event_response request(::orbbec_camera_msgs::srv::SetStreamProfile_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetStreamProfile_Event_response(msg_);
  }
...
class Init_SetStreamProfile_Event_info
{
public:
  Init_SetStreamProfile_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetStreamProfile_Event_request info(::orbbec_camera_msgs::srv::SetStreamProfile_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetStreamProfile_Event_request(msg_);
  }
...
template<>
inline
auto build<::orbbec_camera_msgs::srv::SetStreamProfile_Event>()
{
  return orbbec_camera_msgs::srv::builder::Init_SetStreamProfile_Event_info();
}
