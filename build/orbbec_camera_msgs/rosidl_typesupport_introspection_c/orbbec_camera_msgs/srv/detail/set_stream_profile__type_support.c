...
void orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  orbbec_camera_msgs__srv__SetStreamProfile_Event__init(message_memory);
}

void orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_fini_function(void * message_memory)
{
  orbbec_camera_msgs__srv__SetStreamProfile_Event__fini(message_memory);
}

size_t orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__size_function__SetStreamProfile_Event__request(
  const void * untyped_member)
{
  const orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence * member =
    (const orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_const_function__SetStreamProfile_Event__request(
  const void * untyped_member, size_t index)
{
  const orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence * member =
    (const orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence *)(untyped_member);
...
void * orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_function__SetStreamProfile_Event__request(
  void * untyped_member, size_t index)
{
  orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence * member =
    (orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__fetch_function__SetStreamProfile_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const orbbec_camera_msgs__srv__SetStreamProfile_Request * item =
    ((const orbbec_camera_msgs__srv__SetStreamProfile_Request *)
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_const_function__SetStreamProfile_Event__request(untyped_member, index));
  orbbec_camera_msgs__srv__SetStreamProfile_Request * value =
    (orbbec_camera_msgs__srv__SetStreamProfile_Request *)(untyped_value);
  *value = *item;
}

void orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__assign_function__SetStreamProfile_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  orbbec_camera_msgs__srv__SetStreamProfile_Request * item =
    ((orbbec_camera_msgs__srv__SetStreamProfile_Request *)
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_function__SetStreamProfile_Event__request(untyped_member, index));
  const orbbec_camera_msgs__srv__SetStreamProfile_Request * value =
    (const orbbec_camera_msgs__srv__SetStreamProfile_Request *)(untyped_value);
  *item = *value;
}

bool orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__resize_function__SetStreamProfile_Event__request(
  void * untyped_member, size_t size)
{
  orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence * member =
    (orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence *)(untyped_member);
  orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence__fini(member);
  return orbbec_camera_msgs__srv__SetStreamProfile_Request__Sequence__init(member, size);
}

size_t orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__size_function__SetStreamProfile_Event__response(
  const void * untyped_member)
{
  const orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence * member =
    (const orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_const_function__SetStreamProfile_Event__response(
  const void * untyped_member, size_t index)
{
  const orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence * member =
    (const orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence *)(untyped_member);
...
void * orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_function__SetStreamProfile_Event__response(
  void * untyped_member, size_t index)
{
  orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence * member =
    (orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__fetch_function__SetStreamProfile_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const orbbec_camera_msgs__srv__SetStreamProfile_Response * item =
    ((const orbbec_camera_msgs__srv__SetStreamProfile_Response *)
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_const_function__SetStreamProfile_Event__response(untyped_member, index));
  orbbec_camera_msgs__srv__SetStreamProfile_Response * value =
    (orbbec_camera_msgs__srv__SetStreamProfile_Response *)(untyped_value);
  *value = *item;
}

void orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__assign_function__SetStreamProfile_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  orbbec_camera_msgs__srv__SetStreamProfile_Response * item =
    ((orbbec_camera_msgs__srv__SetStreamProfile_Response *)
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_function__SetStreamProfile_Event__response(untyped_member, index));
  const orbbec_camera_msgs__srv__SetStreamProfile_Response * value =
    (const orbbec_camera_msgs__srv__SetStreamProfile_Response *)(untyped_value);
  *item = *value;
}

bool orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__resize_function__SetStreamProfile_Event__response(
  void * untyped_member, size_t size)
{
  orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence * member =
    (orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence *)(untyped_member);
  orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence__fini(member);
  return orbbec_camera_msgs__srv__SetStreamProfile_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(orbbec_camera_msgs__srv__SetStreamProfile_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(orbbec_camera_msgs__srv__SetStreamProfile_Event, request),  // bytes offset in struct
    NULL,  // default value
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__size_function__SetStreamProfile_Event__request,  // size() function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_const_function__SetStreamProfile_Event__request,  // get_const(index) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_function__SetStreamProfile_Event__request,  // get(index) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__fetch_function__SetStreamProfile_Event__request,  // fetch(index, &value) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__assign_function__SetStreamProfile_Event__request,  // assign(index, value) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__resize_function__SetStreamProfile_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(orbbec_camera_msgs__srv__SetStreamProfile_Event, response),  // bytes offset in struct
    NULL,  // default value
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__size_function__SetStreamProfile_Event__response,  // size() function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_const_function__SetStreamProfile_Event__response,  // get_const(index) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__get_function__SetStreamProfile_Event__response,  // get(index) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__fetch_function__SetStreamProfile_Event__response,  // fetch(index, &value) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__assign_function__SetStreamProfile_Event__response,  // assign(index, value) function pointer
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__resize_function__SetStreamProfile_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_members = {
  "orbbec_camera_msgs__srv",  // message namespace
  "SetStreamProfile_Event",  // message name
  3,  // number of fields
  sizeof(orbbec_camera_msgs__srv__SetStreamProfile_Event),
  false,  // has_any_key_member_
  orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_member_array,  // message members
  orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_type_support_handle = {
  0,
  &orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_orbbec_camera_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile_Event)() {
  orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile_Request)();
  orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile_Response)();
  if (!orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_type_support_handle.typesupport_identifier) {
    orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t orbbec_camera_msgs__srv__detail__set_stream_profile__rosidl_typesupport_introspection_c__SetStreamProfile_service_type_support_handle = {
  ...
  &orbbec_camera_msgs__srv__SetStreamProfile_Request__rosidl_typesupport_introspection_c__SetStreamProfile_Request_message_type_support_handle,
  &orbbec_camera_msgs__srv__SetStreamProfile_Response__rosidl_typesupport_introspection_c__SetStreamProfile_Response_message_type_support_handle,
  &orbbec_camera_msgs__srv__SetStreamProfile_Event__rosidl_typesupport_introspection_c__SetStreamProfile_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_orbbec_camera_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, srv, SetStreamProfile_Event)()->data;
  }
