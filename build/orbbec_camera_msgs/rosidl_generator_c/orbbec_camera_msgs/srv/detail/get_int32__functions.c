...
orbbec_camera_msgs__srv__GetInt32_Request__create(void)
{
...
orbbec_camera_msgs__srv__GetInt32_Request__Sequence__init(orbbec_camera_msgs__srv__GetInt32_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(orbbec_camera_msgs__srv__GetInt32_Request)) {
      return false;
    }
  ...
  orbbec_camera_msgs__srv__GetInt32_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(orbbec_camera_msgs__srv__GetInt32_Request)) {
      return false;
    }
    ...
    orbbec_camera_msgs__srv__GetInt32_Request * data =
      (orbbec_camera_msgs__srv__GetInt32_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!orbbec_camera_msgs__srv__GetInt32_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          orbbec_camera_msgs__srv__GetInt32_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
orbbec_camera_msgs__srv__GetInt32_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
orbbec_camera_msgs__srv__GetInt32_Response__Sequence__init(orbbec_camera_msgs__srv__GetInt32_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(orbbec_camera_msgs__srv__GetInt32_Response)) {
      return false;
    }
  ...
  orbbec_camera_msgs__srv__GetInt32_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(orbbec_camera_msgs__srv__GetInt32_Response)) {
      return false;
    }
    const size_t allocation_size =
    ...
    orbbec_camera_msgs__srv__GetInt32_Response * data =
      (orbbec_camera_msgs__srv__GetInt32_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!orbbec_camera_msgs__srv__GetInt32_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          orbbec_camera_msgs__srv__GetInt32_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
orbbec_camera_msgs__srv__GetInt32_Event__init(orbbec_camera_msgs__srv__GetInt32_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    orbbec_camera_msgs__srv__GetInt32_Event__fini(msg);
    return false;
  }
  // request
  if (!orbbec_camera_msgs__srv__GetInt32_Request__Sequence__init(&msg->request, 0)) {
    orbbec_camera_msgs__srv__GetInt32_Event__fini(msg);
    return false;
  }
  // response
  if (!orbbec_camera_msgs__srv__GetInt32_Response__Sequence__init(&msg->response, 0)) {
    orbbec_camera_msgs__srv__GetInt32_Event__fini(msg);
    return false;
  }
  return true;
...
void
orbbec_camera_msgs__srv__GetInt32_Event__fini(orbbec_camera_msgs__srv__GetInt32_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  orbbec_camera_msgs__srv__GetInt32_Request__Sequence__fini(&msg->request);
  // response
  orbbec_camera_msgs__srv__GetInt32_Response__Sequence__fini(&msg->response);
}

bool
orbbec_camera_msgs__srv__GetInt32_Event__are_equal(const orbbec_camera_msgs__srv__GetInt32_Event * lhs, const orbbec_camera_msgs__srv__GetInt32_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!orbbec_camera_msgs__srv__GetInt32_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!orbbec_camera_msgs__srv__GetInt32_Response__Sequence__are_equal(
...
bool
orbbec_camera_msgs__srv__GetInt32_Event__copy(
  const orbbec_camera_msgs__srv__GetInt32_Event * input,
  orbbec_camera_msgs__srv__GetInt32_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!orbbec_camera_msgs__srv__GetInt32_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!orbbec_camera_msgs__srv__GetInt32_Response__Sequence__copy(
...
orbbec_camera_msgs__srv__GetInt32_Event *
orbbec_camera_msgs__srv__GetInt32_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  orbbec_camera_msgs__srv__GetInt32_Event * msg = (orbbec_camera_msgs__srv__GetInt32_Event *)allocator.allocate(sizeof(orbbec_camera_msgs__srv__GetInt32_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(orbbec_camera_msgs__srv__GetInt32_Event));
  bool success = orbbec_camera_msgs__srv__GetInt32_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
orbbec_camera_msgs__srv__GetInt32_Event__destroy(orbbec_camera_msgs__srv__GetInt32_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    orbbec_camera_msgs__srv__GetInt32_Event__fini(msg);
...
bool
orbbec_camera_msgs__srv__GetInt32_Event__Sequence__init(orbbec_camera_msgs__srv__GetInt32_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  orbbec_camera_msgs__srv__GetInt32_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(orbbec_camera_msgs__srv__GetInt32_Event)) {
      return false;
    }
    data = (orbbec_camera_msgs__srv__GetInt32_Event *)allocator.zero_allocate(size, sizeof(orbbec_camera_msgs__srv__GetInt32_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = orbbec_camera_msgs__srv__GetInt32_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        orbbec_camera_msgs__srv__GetInt32_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
orbbec_camera_msgs__srv__GetInt32_Event__Sequence__fini(orbbec_camera_msgs__srv__GetInt32_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      orbbec_camera_msgs__srv__GetInt32_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
orbbec_camera_msgs__srv__GetInt32_Event__Sequence *
orbbec_camera_msgs__srv__GetInt32_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  orbbec_camera_msgs__srv__GetInt32_Event__Sequence * array = (orbbec_camera_msgs__srv__GetInt32_Event__Sequence *)allocator.allocate(sizeof(orbbec_camera_msgs__srv__GetInt32_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = orbbec_camera_msgs__srv__GetInt32_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
orbbec_camera_msgs__srv__GetInt32_Event__Sequence__destroy(orbbec_camera_msgs__srv__GetInt32_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    orbbec_camera_msgs__srv__GetInt32_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
orbbec_camera_msgs__srv__GetInt32_Event__Sequence__are_equal(const orbbec_camera_msgs__srv__GetInt32_Event__Sequence * lhs, const orbbec_camera_msgs__srv__GetInt32_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!orbbec_camera_msgs__srv__GetInt32_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
orbbec_camera_msgs__srv__GetInt32_Event__Sequence__copy(
  const orbbec_camera_msgs__srv__GetInt32_Event__Sequence * input,
  orbbec_camera_msgs__srv__GetInt32_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(orbbec_camera_msgs__srv__GetInt32_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(orbbec_camera_msgs__srv__GetInt32_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    orbbec_camera_msgs__srv__GetInt32_Event * data =
      (orbbec_camera_msgs__srv__GetInt32_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!orbbec_camera_msgs__srv__GetInt32_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          orbbec_camera_msgs__srv__GetInt32_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!orbbec_camera_msgs__srv__GetInt32_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
