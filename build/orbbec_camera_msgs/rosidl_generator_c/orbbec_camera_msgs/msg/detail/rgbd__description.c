...
orbbec_camera_msgs__msg__RGBD__get_type_hash(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0x50, 0x51, 0x07, 0x3f, 0x34, 0xc3, 0x2d, 0x11,
      0x85, 0x2d, 0x3c, 0x20, 0x4d, 0x8e, 0xe3, 0xab,
      0x47, 0x93, 0x87, 0x08, 0x03, 0x9d, 0xf4, 0xc6,
      0xda, 0x6a, 0x60, 0x65, 0x86, 0xbd, 0x27, 0x90,
    }};
  return &hash;
}
...
static char orbbec_camera_msgs__msg__RGBD__TYPE_NAME[] = "orbbec_camera_msgs/msg/RGBD";
...
static char orbbec_camera_msgs__msg__RGBD__FIELD_NAME__header[] = "header";
static char orbbec_camera_msgs__msg__RGBD__FIELD_NAME__rgb_camera_info[] = "rgb_camera_info";
static char orbbec_camera_msgs__msg__RGBD__FIELD_NAME__depth_camera_info[] = "depth_camera_info";
static char orbbec_camera_msgs__msg__RGBD__FIELD_NAME__rgb[] = "rgb";
static char orbbec_camera_msgs__msg__RGBD__FIELD_NAME__depth[] = "depth";

static rosidl_runtime_c__type_description__Field orbbec_camera_msgs__msg__RGBD__FIELDS[] = {
  {
    {orbbec_camera_msgs__msg__RGBD__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {orbbec_camera_msgs__msg__RGBD__FIELD_NAME__rgb_camera_info, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {orbbec_camera_msgs__msg__RGBD__FIELD_NAME__depth_camera_info, 17, 17},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {orbbec_camera_msgs__msg__RGBD__FIELD_NAME__rgb, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {orbbec_camera_msgs__msg__RGBD__FIELD_NAME__depth, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription orbbec_camera_msgs__msg__RGBD__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
orbbec_camera_msgs__msg__RGBD__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {orbbec_camera_msgs__msg__RGBD__TYPE_NAME, 27, 27},
      {orbbec_camera_msgs__msg__RGBD__FIELDS, 5, 5},
    },
    {orbbec_camera_msgs__msg__RGBD__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
orbbec_camera_msgs__msg__RGBD__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
orbbec_camera_msgs__msg__RGBD__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *orbbec_camera_msgs__msg__RGBD__get_individual_type_description_source(NULL),
