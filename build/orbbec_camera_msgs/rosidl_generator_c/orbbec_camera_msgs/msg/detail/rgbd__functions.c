...
orbbec_camera_msgs__msg__RGBD__create(void)
{
...
orbbec_camera_msgs__msg__RGBD__Sequence__init(orbbec_camera_msgs__msg__RGBD__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(orbbec_camera_msgs__msg__RGBD)) {
      return false;
    }
  ...
  orbbec_camera_msgs__msg__RGBD__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(orbbec_camera_msgs__msg__RGBD)) {
      return false;
    }
