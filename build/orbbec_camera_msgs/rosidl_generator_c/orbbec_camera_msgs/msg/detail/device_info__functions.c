...
orbbec_camera_msgs__msg__DeviceInfo__create(void)
{
...
orbbec_camera_msgs__msg__DeviceInfo__Sequence__init(orbbec_camera_msgs__msg__DeviceInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(orbbec_camera_msgs__msg__DeviceInfo)) {
      return false;
    }
  ...
  orbbec_camera_msgs__msg__DeviceInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(orbbec_camera_msgs__msg__DeviceInfo)) {
      return false;
    }
