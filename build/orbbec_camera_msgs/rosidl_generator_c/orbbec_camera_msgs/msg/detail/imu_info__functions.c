...
orbbec_camera_msgs__msg__IMUInfo__create(void)
{
...
orbbec_camera_msgs__msg__IMUInfo__Sequence__init(orbbec_camera_msgs__msg__IMUInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(orbbec_camera_msgs__msg__IMUInfo)) {
      return false;
    }
  ...
  orbbec_camera_msgs__msg__IMUInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(orbbec_camera_msgs__msg__IMUInfo)) {
      return false;
    }
